defmodule TrivialiseWeb.QuestionControllerTest do
  use TrivialiseWeb.ConnCase

  alias Trivialise.Trivia

  @create_attrs %{points: 42, question: "some question", type: 42}
  ...
  def fixture(:question) do
    {:ok, question} = Trivia.create_question(@create_attrs)
    question
  end
